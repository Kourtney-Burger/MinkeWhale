...
\hypersetup{
  pdftitle={Minke Whale Report},
  pdfauthor={Kourtney Burger; Shannon Rankin},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Minke Whale Report}
\usepackage{etoolbox}
\makeatletter
...
\author{Kourtney Burger \and Shannon Rankin}
\date{12/1/22}
...
\coverauthorstyle{Kourtney Burger, Shannon Rankin\\}};
}
\end{scope}
...
\textcolor{nmfsblue1}{\bfseries{\nohyphens{Minke Whale Report}}}\par
}%
...
\authorstyle{Kourtney
Burger{\textsuperscript{1}}\textsuperscript{,}{\textsuperscript{*}} and Shannon
Rankin{\textsuperscript{1}}%
...
\hangafter=1
\affiliationstyle{
{1}.~Southwest Fisheries Science Center, Marine Mammal and Turtle
Division,  8901 La Jolla Shores DriveLa Jolla, California 92037


\vspace{1\baselineskip} 
* \textit{Correspondence:}~Kourtney Burger~kourtney.burger@noaa.gov
}
}
...
%%%%% end titlepage extension code\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[interior hidden, frame hidden, sharp corners, borderline west={3pt}{0pt}{shadecolor}, enhanced, breakable, boxrule=0pt]}{\end{tcolorbox}}\fi
...
\hypertarget{minke-whale-introduction}{%
\chapter{Minke Whale Introduction}\label{minke-whale-introduction}}

Test citation, information about minke whale boings (Rankin and Barlow
2005).

Rankin and Barlow (2005) discovered the boing sound found in the North
Pacific Ocean was being made by a minke whale, \emph{Balaenoptera
acutorostrata.}
...
\hypertarget{general-locations}{%
\section{General locations}\label{general-locations}}
...
https://doi.org/\url{https://doi.org/10.1121/1.2046747}.
